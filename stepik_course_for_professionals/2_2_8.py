...
emails = [input() for _ in range(int(input()))]  # Создаём список выданных ящиков
new = [input() for _ in range(int(input()))]  # Создаём сприсок новых сотрудников

for i in new:  # Перебираем всех новых сотрудников
    n = 1  # какая цифра будет стоять в названии почты
    name = i + "@beegeek.bzz"
    while name in emails:  # Пока почта уже есть в списке, делаем n+1
